...
*/
func (api *WxOpen) AddToTemplate(ctx context.Context, draftID string) error {
	return api.Client.HTTPPostJson(ctx, apiAddToTemplate, map[string]string{
		"draft_id": draftID,
	}, nil)
}
...
*/
func (api *WxOpen) DeleteTemplate(ctx context.Context, templateID string) error {
	return api.Client.HTTPPostJson(ctx, apiDeleteTemplate, map[string]string{
